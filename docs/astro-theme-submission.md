...
Use this document when filling out the [Astro Developer Portal](https://astro.build/themes/) submission form.
...
This project is a derivative of [astro-blog-zozo](https://github.com/ladit/astro-blog-zozo) by Ladit, inspired by [hugo-theme-zozo](https://github.com/varkai/hugo-theme-zozo). Sample photos are from [Unsplash](https://unsplash.com).
